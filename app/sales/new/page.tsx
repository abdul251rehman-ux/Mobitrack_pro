        ...
        <div className="p-4 space-y-4">
          ...
          {customerMode === "walkin" && outstanding > 0 && (
            <div className="flex items-start gap-2 rounded-lg bg-rose-50 border border-rose-200 px-3 py-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-rose-700">Full payment required for walk-in customers</p>
        ...
        <div className="max-w-lg mx-auto mt-16 flex flex-col items-center gap-6">
            ...
            <div className="px-5 py-4 space-y-2.5">
              ...
              {completedSale.discount > 0 && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-rose-600">âˆ' {formatCurrency(completedSale.discount)}</span>
                </div>
              )}
              {completedSale.tax > 0 && (
                <div className="flex justify-between text-sm">
          ...
          <div className="w-full grid grid-cols-2 gap-2.5">
            {(["save", "preview"] as const).map((action) => {
              const meta = {
                save:    { label: "Save PDF", Icon: FileText, hover: "hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-700" },
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-x-2 gap-y-0.5 mt-0.5">
                          ...
                          {p.batteryHealth != null && (
                            <span className={cn("text-[10px] font-medium", p.batteryHealth >= 80 ? "text-emerald-600" : p.batteryHealth >= 60 ? "text-amber-600" : "text-rose-500")}>
                              ðŸ"‹{p.batteryHealth}%
                            </span>
                          )}
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-3 space-y-2">
            ...
            {customerMode === "existing" && !showNewCustomer && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-8 pl-7 pr-2 text-xs rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                />
            ...
            {customerMode === "existing" && showNewCustomer && (
              <div className="space-y-2 pt-1">
                ...
                <Button size="sm" className="w-full h-7 text-xs bg-indigo-600 hover:bg-indigo-700" onClick={handleCreateCustomer}>Save Customer</Button>
              </div>
            )}
          </div>
